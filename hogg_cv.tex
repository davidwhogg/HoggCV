...
% put in the date -- or not
  \renewcommand{\today}{2019 August 31}
...
\begin{list}{}{\hogglist}
\item
\textsc{nasa} \project{TESS} Guest Investigator Grant (\grantnumber{TBA}{Angus}),
\textit{Measuring long rotation periods from \textsc{tess}'s short light curves,},
\usd{TBD}, 2019--2021.
\item
\textsc{nasa} \project{TESS} Guest Investigator Grant (\grantnumber{TBA}{Hogg}),
\textit{Halo Photometry of Naked-Eye Stars with \textsc{tess}},
\usd{TBD}, 2019--2021.
\item
