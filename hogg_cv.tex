...
%   - Add Valentina best paper award from ICML to honors.
...
\renewcommand{\today}{2025 January 12}
...
\begin{list}{}{\hogglist}
\item
NeurIPS Machine Learning and the Physical Sciences Workshop ``Best AI for Physics'' Paper Award, 2024.
\item
...
\item Gregory,~W.~G., Hogg,~D.~W., Wong,~K.~W.~K., \& Villar,~S., 2024,
  ...
  \textit{NeurIPS Machine Learning for the Physics Sciences Workshop}.
