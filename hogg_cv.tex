...
\project{The Joker} A custom Monte Carlo sampler for the two-body problem.
(\url{http://github.com/adrn/thejoker}).
\item
Bedell,~M., Hogg,~D.~W., \& Foreman-Mackey,~D., 2019,
\project{wobble} codebase for precision radial velocities, MIT license,
